...
#
# Generated by export_simulation on Mon Apr 20 16:02:19 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './dynamic_led3_1.sh' script.

./dynamic_led3_1.sh -reset_run
...
./dynamic_led3_1.sh -noclean_files

For more information on the script, please type './dynamic_led3_1.sh -help'.
