...
--               d:/course/DigitalSystemsExperiment2/fpga/elevator/elevator_0/elevator_0.srcs/sources_1/ip/dynamic_led3_2/dynamic_led3_2_sim_netlist.vhdl
...
entity dynamic_led3_2_dynamic_led3 is
  port (
  ...
  attribute ORIG_REF_NAME of dynamic_led3_2_dynamic_led3 : entity is "dynamic_led3";
end dynamic_led3_2_dynamic_led3;

architecture STRUCTURE of dynamic_led3_2_dynamic_led3 is
  ...
  attribute SOFT_HLUTNM of g0_b6_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of g0_b6_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of g0_b6_i_3 : label is "soft_lutpair0";
...
g0_b6_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
...
g0_b6_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30BB3088"
    )
        port map (
...
entity dynamic_led3_2 is
  ...
  attribute NotValidForBitStream of dynamic_led3_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of dynamic_led3_2 : entity is "dynamic_led3_2,dynamic_led3,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of dynamic_led3_2 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of dynamic_led3_2 : entity is "dynamic_led3,Vivado 2017.4";
end dynamic_led3_2;

architecture STRUCTURE of dynamic_led3_2 is
...
inst: entity work.dynamic_led3_2_dynamic_led3
     port map (
      clk => clk,
